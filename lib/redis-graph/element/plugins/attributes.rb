      ...
      module Attributes
        ...
        module InstanceMethods
          ...
          def add_dynamic_attribute(name, value = nil)
            ...
            self.class.attribute(name, ::RedisGraph::Attributes::Dynamic)
        ...
        def attribute(name, type, options = {})
          ...
          attribute = RedisGraph::Attributes.get(type).new(self, attr_name, options)
        ...
        def dynamic_attribute?(attribute_name)
          !attributes.include?(attribute_name.to_sym) || attributes[attribute_name.to_sym].is_a?(::RedisGraph::Attributes::Dynamic)
        end
        ...
        def key
          @key ||= begin
            ...
            begin
              attribute :key, ::RedisGraph::Attributes::Guid, :key => true
        ...
        def create_attribute_reader(attribute)
          ...
          if attribute.is_a?(::RedisGraph::Attributes::Boolean)
            class_eval <<-EOS, __FILE__, __LINE__ + 1
              #{attribute.reader_visibility}
