    ...
    describe "#eval" do
      describe "Simple Operands" do
        describe "AND" do
          ...
          it "returns a correctly formatted command" do
            @commands.first.should == [:sinterstore, @op.to_key, 'TestNode::indices::foo', 'TestNode::indices::bar']
          end
        ...
        describe "OR" do
          ...
          it "returns a correctly formatted command" do
            @commands.first.should == [:sunionstore, @op.to_key, 'TestNode::indices::foo', 'TestNode::indices::bar']
          end
      ...
      describe "Nested Operations" do
        ...
        it "returns a correctly formatted command" do
          ...
          @commands.last.should  == [:sunionstore, @op2.to_key,  @op1.to_key, 'TestNode::indices::baz']
        end
